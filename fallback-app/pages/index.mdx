...
Welcome to the Plane CI/CD Lab Deployment. This application serves as a lightweight demonstration of AWS infrastructure and GitHub Actions pipelines.

This deployment successfully demonstrates a full CI/CD lifecycle using Docker, PM2, and Nginx on an AWS EC2 instance.
